...
> - 논문 버전 기준: lacp_ijibc_rev7.3
> - 체크리스트 기준: lacp_node_checklist_v10.3
> - 기반 문서: lacp_experiment_guideline_rev1 → rev2 → rev3 → rev4 → rev5 → rev5.1 → rev5.2
...
9. done_reason / truncated_response 정책 확정
10. CR / CR2 baseline 안정성 확보
```
